...
from cmaple.iptables.Tools.ReduceRule import ReduceRule

class IptablesParser:
    instance = None

    def __init__(self, line=0):
        print('__init__ IptablesParser')
    ...
    def merge_protocol(self, protocols_list):
        ...
        """
        print('merge_protocol', protocols_list)
