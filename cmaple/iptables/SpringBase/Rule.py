...
class Rule:
    ...
    def to_string(self, separator='\n'):
        ...
        for i in self.port_dest:
            res += i.to_string()
            res += ","
        res += "]" + separator + "  tcp_flag_list: ["
        for i in self.tcp_flag_list:
            res += i.to_string()
            res += ","
        res += "]" + separator + "  tcp_flag_sets: ["
        for i in self.tcp_flag_sets:
            res += i.to_string()
            res += ","
    ...
    def new_to_string(self, fw, separator='\n'):
        ...
        res += "" + separator + "  tcp_flags: " + str(self.tcp_flags)
